    ...
    private function afterLoad(object:Object):void
    {
        ...
        for(var i:String in object)
        {
            ...
            if(i == 'topics')
            {
                ...
                ///////////////////////////////////////////////////////////////////
                //تایم شروع اولین تاپیک را به صورت دستی برابر با صفر میکنیم
                // تا با کلیک روی اولین تاپیک، برتامه از ابتدا شروع شود نه وسط مدیا
                // و مشکلی هم در آغاز برنامه جهت نمایش تایم لاین به وجود نیاید
                topicsList[0].time = 0;
                ////////////////////////////////////////////////////////////////////
